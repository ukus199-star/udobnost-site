...
export default function Home() {
  ...
  // ─── Экран 1. Приветствие ───────────────────────────────────────────────
  //
  // Порядок блоков задан владелицей 14.09.2026: картинка, заголовок, срок,
    ...
    return (
      <main className="fon-myagkiy flex min-h-screen flex-col px-6 pb-16 pt-[16vh]">
        <div className="mx-auto w-full max-w-chtenie text-center">
          ...
          {/* Срок - тёмным, а не серым, по просьбе владелицы: это единственная
              практическая информация на экране, её должны заметить сразу.
              Человек охотнее начинает, когда знает цену входа.

              Иконка часов нарисована прямо здесь, а не взята эмодзи: эмодзи на
          ...
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 16 16"
              className="size-4 fill-none stroke-akcent"
              strokeWidth="1.5"
              strokeLinecap="round"
            >
                ...
                <div className="px-3 pb-8 pt-3 sm:px-4">
                  ...
                  <div className="ten-myagkaya rounded-myagkiy bg-poverhnost px-6 py-7 text-left sm:px-9">
                    ...
                    {/* Инструкция перенесена сюда из-под кнопки - решение
                        ...
                        свёрнутом блоке её прочтут не все, поэтому в фазе 3 она
                        повторится над первым вопросом, где выбор и делается. */}
                    <p className="mt-3 text-sm leading-relaxed text-priglushennyy">
                      Выбирайте то, как вы поступаете на самом деле, а не то, как
                      было бы правильно.
                    </p>
                  </div>
                </div>
          ...
          {/* Сноска - просьба владелицы 14.09.2026. Видна всегда и не прячется
              под «Подробнее»: это оговорка о том, чем тест является, а чем нет,
              и её должен увидеть каждый, кто нажимает кнопку.
